...
namespace Networking.Server
{
    public class Player
    {
        ...
        public Data.Player player_data;

        public Player(int _id, string _device_id, int _match_id, Data.Player _player_data)
        {
            id = _id;
    ...
    class Client
    {
        ...
        private void Disconnect()
        {
            ...
            if(player != null)
                Database.OnPlayerDisconnect(player.player_data.nickname,player.player_data.account_id, player.match_id);
            player = null;
        }
